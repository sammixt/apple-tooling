    ...
    if len(json_data) > 0:
        ...
        for conversation in json_data:
            ...
            if "image_distribution" in conversation.get("notes", {}):
                ...
                for category, subcategory in image_distribution.items():
                    ...
                    if category_name:
                        if category_name not in image_distribution_groups:
                            image_distribution_groups[category_name] = {"total_rlhf_turn": 0, "total_count": 0, "sft_turn": 0, "total_turn": 0}

                        image_distribution_groups[category_name]["total_count"] += 1
                    ...
                    if subcategory_name:
                        if subcategory_name not in image_distribution_groups:
                            image_distribution_groups[subcategory_name] = {"total_rlhf_turn": 0, "total_count": 0, "sft_turn": 0, "total_turn": 0}

                        image_distribution_groups[subcategory_name]["total_count"] += 1
